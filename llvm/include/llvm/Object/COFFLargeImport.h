...
struct COFFLargeImportHeader {
  ...
  support::ulittle16_t Version; /// Must always be 1
  ...
  support::ulittle16_t SizeOfSymbolName; /// Size of the symbol name. Name is not null terminated.
...
struct COFFLargeLoaderImportSectionHeader {
  support::aligned_ulittle16_t Version; /// Must always be 1
...
struct COFFLargeLoaderExportSectionHeader {
  support::aligned_ulittle16_t Version; /// Must always be 1
  ...
  support::aligned_ulittle32_t SectionHeaderRVA; /// RVA of this section header. This can be used to calculate the base address of the image
  support::aligned_ulittle32_t ImageFilenameOffset; /// Offset to the name of this image from the start of the section. Used for debugging and error messages. Name is null terminated
  support::aligned_ulittle32_t ImageFilenameLength; /// Length of the name of the image. Does not include null terminator
};
